...
import 'package:panel_apk/src/presentation/page/country_code/widget/country_code_form_delete.dart';

import '../../../widget/button.dart';

class CountryCodeTable extends StatelessWidget {
  const CountryCodeTable({super.key});
    ...
    return Expanded(
      child: DataTable2(
        ...
        columns: const [
          ...
          DataColumn2(label: Text('Country Code'), size: ColumnSize.L, headingRowAlignment: MainAxisAlignment.center),
        ...
        rows: List<DataRow>.generate(
          ...
          (index) => DataRow(
            cells: [
              ...
              DataCell(Center(child: Text('US${index + 1}'))),
              DataCell(Row(
