...
import 'ip_form_delete.dart';

class IpTable extends StatelessWidget {
  const IpTable({super.key});
    ...
    return Expanded(
      child: DataTable2(
        ...
        columns: const [
          ...
          DataColumn2(label: Text('Ip Address'), size: ColumnSize.L, headingRowAlignment: MainAxisAlignment.center),
