...
import 'package:panel_apk/src/presentation/page/webview/widget/webview_form_delete.dart';

import '../../../widget/button.dart';

class WebviewTable extends StatelessWidget {
  const WebviewTable({super.key});
    ...
    return Expanded(
      child: DataTable2(
        ...
        columns: const [
          ...
          DataColumn2(label: Text('URL / Domain'), size: ColumnSize.L),
