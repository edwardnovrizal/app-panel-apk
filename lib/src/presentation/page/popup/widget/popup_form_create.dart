...
popupFormCreate({
  ...
  return appShowModal(
    context: context,
    title: const Text("Tambah Unit Notification Pop Up", textAlign: TextAlign.center),
            ...
            child: Column(
              ...
              children: [
                AppTextForm(
                  ...
                  hintText: "Masukkan title untuk notification pop up",
                  onChanged: (p0) {
                    if (p0.isNotEmpty) {}
                  },
                ),
                AppTextForm(
                  ...
                  controller: desc,
                  preffixIcon: const Icon(Icons.perm_identity_rounded),
                  hintText: "Masukkan deskripsi untuk notification pop up",
                  onChanged: (p0) {
                    if (p0.isNotEmpty) {}
                  },
                ),
