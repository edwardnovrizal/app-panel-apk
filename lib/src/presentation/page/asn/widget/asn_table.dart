...
import 'asn_form_delete.dart';

class AsnTable extends StatelessWidget {
  const AsnTable({super.key});
    ...
    return Expanded(
      child: DataTable2(
        ...
        columns: const [
          ...
          DataColumn2(label: Text('ASN'), size: ColumnSize.L, headingRowAlignment: MainAxisAlignment.center),
        ...
        rows: List<DataRow>.generate(
          ...
          (index) => DataRow(
            cells: [
              ...
              DataCell(Center(child: Text('TELKOMSEL${index + 1}'))),
              DataCell(Row(
